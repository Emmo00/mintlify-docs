...
description: "This section provides a conceptual, external-facing view of the protocol's data and attestation mechanisms, including how offchain business data is anchored onchain, the privacy model, business metadata, index concepts, and reconciliation records. Implementation-specific details have been removed or abstracted."
---

### Attestations — Purpose and Public Schema (Conceptual)
...
The protocol maintains reconciliation artifacts that link offchain receipts and bridging events to onchain distributions. Key external-facing record types include:
