...
description: "This documentation provides high-level user and business interaction flows within the BizFi and BizMarket ecosystem, abstracting internal operational procedures while flagging removed internal-only details."
---
...
1. **Application Submission** — Business submits required information and supporting documents through the public onboarding interface.
...
2. **Eligibility Verification** — Protocol verifies instrument status and external-facing eligibility criteria.
...
Key Steps (external view):

1. **Contribution** — Provider deposits stablecoins into a public liquidity pool.
...
Narrative: Businesses remit repayments or revenue shares which are ultimately used to fund onchain distributions to investors. External documentation describes responsibilities and sequencing without exposing internal reconciliation workflows.

Key Steps:

1. **Business Payment** — Business remits payments as required by the instrument terms.
2. **Funds Receipt & Verification** — Protocol acknowledges receipt and verifies amounts (external-facing confirmation only).
...
Referral mechanisms and agent programs facilitate acquisition and onboarding; attribution and rewards are applied per public program rules.
